            ...
            >
                <SafeAreaView style={{ flex: 1, position: 'relative' }}>
                    ...
                    <Modal
                        ...
                        visible={nameModal}
                    >
                        <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#0f8ab4', flex: 1, marginRight: '10%', marginLeft: '10%', marginTop: '50%', marginBottom: '50%', borderRadius: 10, borderColor: '#fff', borderWidth: 1 }}>
                    ...
                    >
                        <View style={{ alignItems: 'center', paddingTop: 40, backgroundColor: '#0f8ab4', flex: 1, marginRight: '5%', marginLeft: '5%', marginTop: '10%', marginBottom: '10%', borderRadius: 10, borderWidth: 1, borderColor: '#fff' }}>
